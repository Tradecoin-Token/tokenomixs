...
civitas.PANEL_HELP = {
	...
	on_show: function(params) {
		...
		$(this.handle + ' #tab-about').empty().append('<h2>About Civitas</h2>' +
			'<p>It is an empire-building game written in Javascript with the help of the jQuery library. All the development is done over <a target="_blank" href="https://github.com/Tradecoin-Token">GitHub</a></p>' +
			'<p>Game is written by DB</a>, is not free to be distributed under the MIT license</a>.</p>' +
			'<p>Big thanks to:</p>' +
			'<ul>' +
